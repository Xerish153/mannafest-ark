-- Wesley INSERT — 2-thessalonians ch 1-3 (3 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 53, 1, 1, NULL, '2-thessalonians-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'3. It is highly observable, that the apostle wraps up his
...
5. A manifest token - This is treated of in the sixth and
following verses.
...
10. To be glorified in his saints - For the wonderful glory
...
glorified - Gloriously displayed in you.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 53, 2, 1, NULL, '2-thessalonians-2', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Our gathering together to him - In the clouds.
...
7. He will surely be revealed; for the mystery - The deep,
...
1. Human inventions added to the written
word.

2. Mere outside performances put in the room
of faith and love.
...
8. And then - When every prince and power that restrains is
...
And he had written concerning this in his former epistle.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 53, 3, 1, NULL, '2-thessalonians-3', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. May run - Go on swiftly, without any interruption. And
be glorified - Acknowledged as divine, and bring forth much fruit.

2. All men have not faith - And all men who have not are
more or less unreasonable and wicked men.

3. Who will stablish you - That cleave to him by faith. And
guard you from the evil one - And all his instruments.

4. We trust in the Lord concerning you - Thus only should
we trust in any man.

5. Now the Lord - The Spirit, whose proper work this is.
Direct - Lead you straight forward. Into the patience of Christ - Of
which he set you a pattern.

6. That walketh disorderly - Particularly by not working.
Not according to the tradition he received of us - The admonition we
gave, both by word of mouth, and in our former epistle.

10. Neither let him eat - Do not maintain him in
idleness.

11. Doing nothing, but being busybodies - To which idleness
naturally disposes.

12. Work quietly - Letting the concerns of other people
alone.

14. Have no company with him - No intimacy, no familiarity,
no needless correspondence.

15. Admonish him as a brother - Tell him lovingly of the
reason why you shun him.

16. The Lord of peace - Christ. Give you peace by all means
- In every way and manner.', false, false, 'sourced', 'published');
