-- Wesley INSERT — philippians ch 1-4 (4 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 50, 1, 1, NULL, 'philippians-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Servants - St. Paul, writing familiarly to the
...
5. The sense is, I thank God for your fellowship with us in
...
7. As it is right for me to think this of you all - Why? He
...
9. And this I pray, that your love - Which they had already
...
18. In pretense - Under colour of propagating the gospel.
...
30. Having the same kind of conflict with your adversaries,
which ye saw in me - When I was with you, Acts xvi, 12, 19, &c.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 50, 2, 1, NULL, 'philippians-2', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. If there be therefore any consolation - In the grace of
...
8. And being found in fashion as a man - A common man,
...
10. That every knee - That divine honour might be paid in
...
14. Do all things - Not only without contention, ver. 3,
...
17. Here he begins to treat of the latter clause of chap.
...
19. When I know - Upon my return, that ye stand
steadfast.
...
27. God had compassion on him - Restoring him to
health.
...
could not do in person.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 50, 3, 1, NULL, 'philippians-3', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. The same things - Which you have heard before.
...
6. Having such a zeal for it as to persecute to the death
...
7. But all these things, which I then accounted gain, which
...
8. Yea, I still account both all these and all things else
...
10. The knowledge of Christ, mentioned in the eighth verse,
...
15. Let us, as many as are perfect - Fit for the race,
...
16. But let us take care not to lose the ground we have
already gained. Let us walk by the same rule we have done hitherto.

17. Mark them - For your imitation.

18. Weeping - As he wrote. Enemies of the cross of Christ -
...
in his heavenly kingdom, and on his triumphant throne.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 50, 4, 1, NULL, 'philippians-4', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. So stand - As ye have done hitherto.

2. I beseech - He repeats this twice, as if speaking to
each face to face, and that with the utmost tenderness.

3. And I entreat thee also, true yokefellow - St. Paul had
...
13. I can do all things - Even fulfil all the will of
God.
...
riches in glory - In his abundant, eternal glory.', false, false, 'sourced', 'published');
