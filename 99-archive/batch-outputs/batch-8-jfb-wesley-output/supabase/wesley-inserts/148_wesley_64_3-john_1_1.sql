-- Wesley INSERT — 3-john ch 1-1 (1 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 64, 1, 1, NULL, '3-john-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Caius was probably that Caius of Corinth whom St. Paul
...
8. To receive - With all kindness. The truth - Which they
preach.

9. I wrote to the church - Probably that to which they
...
11. Follow not that which is evil - In Diotrephes. But that
which is good - In Demetrius. He hath not seen God - Is a stranger to
him.

12. And from the truth itself - That is, what they testify
...
of brother.', false, false, 'sourced', 'published');
