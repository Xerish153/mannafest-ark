-- Wesley INSERT — titus ch 1-3 (3 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 56, 1, 1, NULL, 'titus-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Paul, a servant of God, and an apostle of Jesus Christ -
...
5. The things which are wanting - Which I had not time to
...
does.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 56, 2, 1, NULL, 'titus-2', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Wholesome - Restoring and preserving spiritual
health.
...
will despise a true minister of his word.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 56, 3, 1, NULL, 'titus-3', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Remind them - All the Cretan Christians. To be subject -
...
(2.) Sanctification, expressed by the laver
...
3. The consummation of all; - that we might
become heirs of eternal life, and live now in the joyful hope of it.

8. Be careful to excel in good works - Though the apostle
...
11. Such an one is perverted - In his heart, at least. And
sinneth, being self-condemned - Being convinced in his own conscience
that he acts wrong.

12. When I shall send Artemas or Tychicus - To succeed thee
...
13. Send forward Zenas the lawyer - Either a Roman lawyer
or an expounder of the Jewish law.

14. And let ours - All our brethren at Crete. Learn - Both
by thy admonition and example. Perhaps they had not before assisted
Zenas and Apollos as they ought to have done.', false, false, 'sourced', 'published');
