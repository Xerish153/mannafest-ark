-- Wesley INSERT — jude ch 1-1 (1 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 65, 1, 1, NULL, 'jude-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Jude, a servant of Jesus Christ - The highest glory
...
4. There are certain men crept in, who were of old
...
7. The cities which gave themselves over to fornication -
...
8. In like manner these dreamers - Sleeping and dreaming
...
9. Yet Michael - It does not appear whether St. Jude
...
10. But these - Without all shame. Rail at the things of
...
11. Woe unto them - Of all the apostles St. Jude alone, and
...
12. These are spots - Blemishes. In your feasts of love -
...
13. Wandering stars - Literally, planets, which shine for a
...
14. And of these also - As well as the antediluvian sinners
...
15. To execute judgment - Enoch herein looked beyond the
...
16. These are murmurers - Against men. Complainers -
...
17. By the apostles - He does not exempt himself from the
...
1. That by the church is meant a body of
...
3. That we have no more authority from
scripture to call even this schism, than to call it murder.

20. But ye, beloved, not separating, but building
...
21. By these means, through his grace, keep yourselves in
...
24. Now to him who alone is able to keep them from falling
...
revealed in all his glory. Please see Notes at Matt. i, 1', false, false, 'sourced', 'published');
