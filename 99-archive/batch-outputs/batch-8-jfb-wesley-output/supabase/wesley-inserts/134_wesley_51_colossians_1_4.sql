-- Wesley INSERT — colossians ch 1-4 (4 rows, testament=NT)
...
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 51, 1, 1, NULL, 'colossians-1', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'2. The saints-This word expresses their union with God. And
...
9. We pray for you - This was mentioned in general, Colossians i, 3, but now more particularly. That ye may be filled with the
...
12. Who, by justifying and sanctifying us, hath made us
meet for glory.
...
18. And - From the whole he now descends to the most
...
19. For it pleased the Father that all fulness - All the
...
21. And you that were alienated, and enemies - Actual
...
23. If ye continue in the faith - Otherwise, ye will lose
...
25. According to the dispensation of God which is given me
...
27. Christ dwelling and reigning in you, The hope of glory
- The ground of your hope.

28. We teach the ignorant, and admonish them that are
already taught.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 51, 2, 1, NULL, 'colossians-2', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. How great a conflict - Of care, desire, prayer. As many
...
7. Rooted in him - As the vine. Built - On the sure
foundation.
...
10. And ye - Who believe. Are filled with him - John i, 16. Christ is filled with God, and ye are filled with Christ.
...
16. Therefore - Seeing these things are so. Let none judge
...
17. Which are but a lifeless shadow; but the body, the
substance, is of Christ.

18. Out of pretended humility, they worshipped angels, as
...
19. And not holding the head - He does not hold Christ, who
does not trust in him alone. All the members are nourished by faith, and
knit together by love and mutual sympathy.

20. Therefore - The inference begun, Colossians ii, 16; is continued. A new inference follows, Colossians iii, 1. If ye are dead with Christ from the rudiments of the world
...
21. Touch not - An unclean thing. Taste not - Any forbidden
meat. Handle not - Any consecrated vessel.

22. Perish in the using - Have no farther use, no influence
on the mind.

23. Not sparing the body - Denying it many gratifications,
...
of being distinguished from others.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 51, 3, 1, NULL, 'colossians-3', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. If ye are risen, seek the things above - As Christ being
risen, immediately went to heaven.

3. For ye are dead - To the things on earth. And your real,
...
6. For which - Though the heathens lightly regarded
them.

7. Living denotes the inward principle; walking, the
outward acts.
...
10. In knowledge - The knowledge of God, his will, his
word.
...
22. Eyeservice - Being more diligent under their eye than
...
treatment of those they serve cannot disappoint.', false, false, 'sourced', 'published'),
('620d504d-0a76-41f1-a87f-9b26cfab02de'::uuid, 51, 4, 1, NULL, 'colossians-4', 'John Wesley', 'Explanatory Notes Upon the New Testament', E'1. Just - According to your contract. Equitable - Even
beyond the letter of your contract.

3. That God would open to us a door of utterance - That is,
give us utterance, that we "may open our mouth boldly," Eph. vi, 19, and give us an opportunity of speaking, so that none may be
able to hinder.

6. Let your speech be always with grace - Seasoned with the
grace of God, as flesh is with salt.

10. Aristarchus my fellowprisoner - Such was Epaphras
...
11. These - Three, Aristarchus, Marcus, and Justus. Of all
...
12. Perfect - Endued with every Christian grace. Filled -
...
14. Luke, the physician - Such he had been, at least, if he
was not then.

15. Nymphas - Probably an eminent Christian at
Laodicea.

16. The epistle from Laodicea - Not to Laodicea. Perhaps
some letter had been written to St. Paul from thence.

17. And say to Archippus - One of the pastors of that
...
and for whose sake, we receive the various gifts of the Holy Spirit.', false, false, 'sourced', 'published');
