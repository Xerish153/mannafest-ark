-- JFB INSERT — hebrews ch 1-10 (10 rows)
...
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 1, 1, NULL, 'hebrews-1', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'THE
HIGHEST OF
ALL
REVELATIONS
IS
...
He rules; they serve.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 2, 1, NULL, 'hebrews-2', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'DANGER OF
NEGLECTING
SO
GREAT
SALVATION,
...
experimental feeling."', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 3, 1, NULL, 'hebrews-3', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'THE
SON OF
GOD
GREATER THAN
MOSES,
...
wilderness: still, even when in it, they never fully enjoyed
...
lest there be--Greek (indicative), "lest there
shall be"; lest there be, as I fear there is; implying that it
is not merely a possible contingency, but that there is ground
for thinking it will be so.

in any--"in any one of you." Not merely ought all in general be
on their guard, but they ought to be so concerned for the safety of
each one member, as not to suffer any one to perish through
their negligence [CALVIN].
...
unbelief--faithlessness. Christ is faithful;
therefore, saith Paul to the Hebrews, we ought not to be
faithless as our fathers were under Moses.
...
the living God--real: the distinctive characteristic of the God
...
the beginning of our confidence--that is, the confidence
(literally, substantial, solid confidence) of faith which we
have begun

(Heb 6:11; 12:2).

A Christian so long as he is not made perfect, considers himself
...
not a mere invitation, but also an actual enjoyment." ALFORD translates, "Since (that is, ''for'') it is said,"
&c., regarding
...
corpses--literally, "limbs," implying that their bodies fell
limb from limb.

18. to them that believed not--rather as Greek, "to them
that disobeyed." Practical unbelief

(De 1:26).

19. they could not enter--though desiring it.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 4, 1, NULL, 'hebrews-4', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'THE
PROMISE OF
GOD''S
REST
IS
...
"He is able to succor them that are tempted."', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 5, 1, NULL, 'hebrews-5', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'CHRIST''S
HIGH
PRIESTHOOD;
NEEDED
QUALIFICATIONS;
...
Heb 13:9.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 6, 1, NULL, 'hebrews-6', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'WARNING AGAINST
RETROGRADING,
WHICH
SOON
LEADS TO
...
earth, so Christ is ours in heaven.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 7, 1, NULL, 'hebrews-7', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'CHRIST''S
HIGH
...
the right hand of the Father.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 8, 1, NULL, 'hebrews-8', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'CHRIST, THE
HIGH
PRIEST IN THE
TRUE
SANCTUARY,
...
-- JFB58B.HTM --', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 9, 1, NULL, 'hebrews-9', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'INFERIORITY OF THE
OLD TO THE
NEW
COVENANT IN THE
MEANS OF
...
and after, His second coming.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 58, 10, 1, NULL, 'hebrews-10', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'CONCLUSION OF THE
FOREGOING
ARGUMENT.
THE
YEARLY
...
[DELITZSCH in ALFORD].', false, false, 'sourced', 'published');
