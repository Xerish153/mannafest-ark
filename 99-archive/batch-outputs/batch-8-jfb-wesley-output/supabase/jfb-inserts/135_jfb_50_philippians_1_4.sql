-- JFB INSERT — philippians ch 1-4 (4 rows)
...
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 50, 1, 1, NULL, 'philippians-1', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'INSCRIPTION.
THANKSGIVING AND
PRAYERS FOR THE
FLOURISHING
SPIRITUAL
...
(Php 1:27).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 50, 2, 1, NULL, 'philippians-2', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'CONTINUED
EXHORTATION:
TO
UNITY:
TO
...
[ALFORD].', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 50, 3, 1, NULL, 'philippians-3', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'WARNING AGAINST
JUDAIZERS:
HE
HAS
GREATER
...
(Mic 2:13).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 50, 4, 1, NULL, 'philippians-4', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'EXHORTATIONS:
THANKS FOR THE
SUPPLY FROM
PHILIPPI:
GREETING; AND
...
Corinth [PALEY, Horæ Paulinæ].
However, the supply meant here is not that which he received at
Corinth, but the supply sent to him when "in Thessalonica, once and
again"
...
ye only--We are not to wait for others in a good work, saying, "I
will do so, when others do it." We must go forward, though alone.

16. even in Thessalonica--"even" as early as when I had got no further
than Thessalonica, ye sent me supplies for my necessities more than
once.

17. a gift--Greek, "the gift." Translate, "It is not that
I seek after the gift, but I do seek after the fruit that
aboundeth to your account"; what I do seek is your spiritual good,
in the abounding of fruits of your faith which shall be put down to your
...
the odour of a sweet smell--(See on

Eph 5:2).

The figure is drawn from the sweet-smelling incense which was burnt
along with the sacrifices; their gift being in faith was not so much to
Paul, as to God

(Mt 25:40),

before whom it "came up for a memorial"

(Ac 10:4),

sweet-smelling in God''s presence
...
according to his riches--The measure of His supply to you will be
...
be glory--rather as the Greek, "be the glory." Not to us, but
to Him be "the glory" alike of your gift, and of His gracious
recompense to you.
...
The brethren which are with me--Perhaps Jewish believers are meant
...
ministry" [ALFORD]; he had only one close friend
with him, namely, Timothy.

22. they that are of Cæsar''s household--the slaves and dependents
of Nero who had been probably converted through Paul''s teaching while he
was a prisoner in the Prætorian barrack attached to the palace.
