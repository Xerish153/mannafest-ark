-- JFB INSERT — 1-thessalonians ch 1-5 (5 rows)
...
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 52, 1, 1, NULL, '1-thessalonians-1', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'ADDRESS:
SALUTATION:
HIS
PRAYERFUL
THANKSGIVING FOR
...
(1Th 5:9;
Col 3:6).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 52, 2, 1, NULL, '1-thessalonians-2', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'HIS
MANNER OF
PREACHING, AND
THEIRS OF
RECEIVING, THE
...
now our glory and joy.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 52, 3, 1, NULL, '1-thessalonians-3', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'PROOF OF
HIS
DESIRE AFTER
THEM IN
HIS
...
in "stablishing."', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 52, 4, 1, NULL, '1-thessalonians-4', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'EXHORTATIONS TO
CHASTITY;
BROTHERLY
LOVE;
QUIET
...
from regarding their departed brethren as anticipating them in
entering glory, that they needed to be assured that those who remain to
the coming of the Lord "will not anticipate them that are asleep." The
"we" means whichever of us are alive and remain unto the coming
of the Lord. The Spirit designed that believers in each successive age
should live in continued expectation of the Lord''s coming, not knowing
but that they should be among those found alive at His coming

(Mt 24:42).

It is a sad fall from this blessed hope, that death is looked
for by most men, rather than the coming of our Lord. Each successive
...
The Spirit subsequently revealed by Paul that which is not inconsistent
with the expectation here taught of the Lord''s coming at any time;
namely, that His coming would not be until there should be a "falling
away first"
...
for going to be with Christ in the meanwhile

(2Co 5:1-10;
Php 1:6, 23; 3:20, 21; 4:5).

EDMUNDS well says, The "we" is an affectionate
identifying of ourselves with our fellows of all ages, as members of
the same body, under the same Head, Christ Jesus. So

Ho 12:4,

"God spake with us in Beth-el," that is, with Israel.
"We did rejoice," that is, Israel at the Red Sea

(Ps 66:6).

Though neither Hosea, nor David, was alive at the times referred to,
yet each identifies himself with those that were present.
...
"signal shout." Michael is perhaps meant
...
it simply stands in opposition to "then,"

1Th 4:17.

FIRST, "the dead in Christ" shall rise,
THEN the living shall be caught up. The
Lord''s people alone are spoken of here.

17. we which are alive . . . shall be caught up--after
having been "changed in a moment"

(1Co 15:51, 52).

Again he says, "we," recommending thus the expression to Christians of
all ages, each generation bequeathing to the succeeding one a
continually increasing obligation to look for the coming of the Lord.
[EDMUNDS].

together with them--all together: the raised dead, and changed
living, forming one joint body.

in the clouds--Greek, "in clouds." The same honor is
conferred on them as on their Lord. As He was taken in a cloud at His
ascension

(Ac 1:9),

so at His return with clouds

(Re 1:7),

they shall be caught up in clouds. The clouds are His and their
triumphal chariot

(Ps 104:3;
Da 7:13).

ELLICOTT explains the Greek, "robed round
by upbearing clouds" [Aids to Faith].

in the air--rather, "into the air"; caught up into
the region just above the earth, where the meeting (compare
...
His point being established, that the dead in Christ shall be on terms
of equal advantage with those found alive at Christ''s coming, he leaves
...
(1Th 4:13).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 52, 5, 1, NULL, '1-thessalonians-5', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'THE
SUDDENNESS OF
CHRIST''S
COMING A
MOTIVE FOR
...
14. brethren--This exhortation to "warn (Greek,
''admonish,'' as in
