-- JFB INSERT — ecclesiastes ch 1-10 (10 rows)
...
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 1, 1, NULL, 'ecclesiastes-1', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'INTRODUCTION.
...
(Ec 1:15; 12:12).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 2, 1, NULL, 'ecclesiastes-2', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'He next tries pleasure and luxury, retaining however, his worldly
"wisdom"
...
(2Ch 12:9).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 3, 1, NULL, 'ecclesiastes-3', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'Earthly pursuits are no doubt lawful in their proper time and order
...
(Mt 6:20, 25, 31-34).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 4, 1, NULL, 'ecclesiastes-4', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. returned--namely, to the thought set forth
...
him.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 5, 1, NULL, 'ecclesiastes-5', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. From vanity connected with kings, he passes to vanities
...
is simplest.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 6, 1, NULL, 'ecclesiastes-6', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. common--or else more literally,--"great upon man," falls heavily
upon man.
...
he states what is good, in answer to this verse.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 7, 1, NULL, 'ecclesiastes-7', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. (See on
...
Eve, and their posterity.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 8, 1, NULL, 'ecclesiastes-8', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. Praise of true wisdom continued
...
that is, Speculations above what is written are vain.', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 9, 1, NULL, 'ecclesiastes-9', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. declare--rather, explore; the result of my exploring is this, that
"the righteous, &c., are in the hand of God. No man knoweth either the
love or hatred (of God to them) by all that is before them," that is, by
what is outwardly seen in His present dealings

(Ec 8:14, 17).

However, from the sense of the same words, in

Ec 9:6,

"love and hatred" seem to be the feelings of the wicked towards the
righteous, whereby they caused to the latter comfort or sorrow.
Translate: "Even the love and hatred" (exhibited towards the righteous,
are in God''s hand)

(Ps 76:10;
Pr 16:7).

"No man knoweth all that is before them."
...
but of yet repenting and being saved.
...
dead know not anything--that is, so far as their bodily
senses and worldly affairs are concerned

(Job 14:21;
Isa 63:16);

also, they know no door of repentance open to them, such as is to all
on earth.
...
but the wicked, who with all the pains to perpetuate their names
...
that they now "cannot have any more."

7. Addressed to the "righteous wise," spoken of in

Ec 9:1.

Being "in the hand of God," who now accepteth "thy works" in His
service, as He has previously accepted thy person

(Ge 4:4),

thou mayest "eat . . . with a cheerful (not sensually
''merry'') heart"
...
9. wife . . . lovest--godly and true love, opposed to the "snares"
of the "thousand" concubines

(Ec 7:26, 28),

"among" whom Solomon could not find the true love which joins one man
to one woman

(Pr 5:15, 18, 19; 18:22; 19:14).
...
"The soul''s play-day is Satan''s work-day; the idler the man the busier
the tempter" [SOUTH].
...
13. Rather, "I have seen wisdom of this kind also," that is, exhibited
in the way which is described in what follows [MAURER].
...
for his wisdom could not have saved the city, had "his words not
been heard"; but poor men in general. So Paul
...
Solomon reverts to "the rulers to their own hurt"
...
Though wisdom excels folly

(Ec 9:16; 7:19),

yet a "little folly (equivalent to sin) can destroy much good,"
both in himself

(Ec 10:1;
Jas 2:10)

and in others. "Wisdom" must, from the antithesis to "sinner," mean
religion. Thus typically, the "little city" may be applied to the
Church

(Lu 12:32;
Heb 12:22);

the great king to Satan

(Joh 12:31);

the despised poor wise man, Jesus Christ

(Isa 53:2, 3;
Mr 6:3;
2Co 8:9;
Eph 1:7, 8;
Col 2:3).', false, false, 'sourced', 'published'),
('6d360491-df42-43ef-881e-b7413dcfd878'::uuid, 21, 10, 1, NULL, 'ecclesiastes-10', 'Jamieson, Fausset & Brown', 'Commentary Critical and Explanatory', E'1. Following up
...
That he "saith," virtually, "that he" himself, &c.
[Septuagint]. But Vulgate, "He thinks that every
one (else whom he meets) is a fool."
...
This explains "leave not thy place"; do not in a resisting
spirit withdraw from thy post of duty

(Ec 8:3).

5. as--rather, "by reason of an error"
[MAURER and
HOLDEN].

6. rich--not in mere wealth, but in wisdom, as the antithesis to
"folly" (for "foolish men") shows. So Hebrew, rich, equivalent to
"liberal," in a good sense
...
8. The fatal results to kings of such an unwise policy; the wrong
done to others recoils on themselves

(Ec 8:9);

they fall into the
pit which they dug for others
...
the stones of his neighbor''s garden wall

(Ps 80:12),

which he maliciously pulls down
...
endangered--by the splinters, or by the head of the hatchet, flying
back on himself. Pithy aphorisms are common in the East. The sense is:
...
forcing matters by main "strength" to one''s own hurt

(Ec 9:16, 18).

11. A "serpent will bite" if "enchantment" is not used; "and a babbling
calumniator is no better." Therefore, as one may escape a serpent by
charms

(Ps 58:4, 5),

so one may escape the sting of a calumniator by discretion

(Ec 10:12),

[HOLDEN]. Thus, "without enchantment" answers
to "not whet the edge"

(Ec 10:10),

both expressing, figuratively, want of judgment. MAURER translates, "There is no gain to the enchanter"
(Margin, "master of the tongue") from his enchantments,
...
and following verses, caution in speaking.
...
(Pr 10:8, 14, 21, 32; 12:13;
15:2; 22:11).

13. Illustrating the folly and injuriousness of the fool''s
words; last clause of
...
(Ec 3:22; 6:12; 8:7; 11:2;
Pr 27:1).

If man, universally (including the wise man), cannot foresee the
future, much less can the fool; his "many words" are therefore
futile.
...
knoweth not how to go to the city--proverb for
ignorance of the most ordinary matters

(Ec 10:3);

spiritually, the heavenly city
...
with the following verses. The labor (vexation) caused by the foolish
(injurious princes,

Ec 10:4-7)

harasses him who "knows not how to go to the city," to ingratiate
himself with them there. English Version is simpler.
...
eat in the morning--the usual time for dispensing justice in the
East

(Jer 21:12);

here, given to feasting
...
not until duty has first been attended to.
...
Instead of repairing the breaches in the commonwealth (equivalent to
"building"), the princes "make a feast for laughter
...
and (but) money supplieth (answereth their wishes by supplying) all
things," that is, they take bribes to support their
extravagance; and hence arise the wrongs that are perpetrated

(Ec 10:5, 6; 3:16;
Isa 1:23; 5:23).

MAURER takes "all things" of
the wrongs to which princes are instigated by "money"; for example,
the heavy taxes, which were the occasion of Rehoboam losing ten tribes
...
the "thought," is figurative. But it literally holds good of the King of
kings

(Ps 139:1-24),

whose consciousness of every evil thought we should ever realize.
...
in a way as marvellous and rapid, as if birds or some winged messenger
carried to the king information of the curse so uttered. In the East
superhuman sagacity was attributed to birds (see on

Job 28:21;

hence the proverb).', false, false, 'sourced', 'published');
